...
/**
 * Utility class for managing browser cookies in a web app.
 *
 * Provides simple methods to add, read, and delete cookies for 
 * storing small user data like login status or preferences.
 * 
 * @author Santosh Lama 
 * LMU ID- 23048594
 */
